      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>게시판 링크</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="/board/listPage"><i class="fa fa-circle-o"></i> 게시판 페이징처리(listPage)</a></li>
                <li><a href="/board/register"><i class="fa fa-circle-o"></i>게시판 등록(register)</a></li>
                <li><a href="/board/listAll"><i class="fa fa-circle-o"></i>게시판 보기(listAll)</a></li>
                <li><a href="/sboard/list"><i class="fa fa-circle-o"></i>게시판 보기 & 검색(list)</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
